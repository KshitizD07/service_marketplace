...
- [ ] **Task 1.1: Dependency Verification**
  ...
  ```
- [ ] **Task 1.2: Environment Configuration (`src/config/env.js`)**
  Create a strict environment loader that validates existence of:
  - `PORT` (Default: 5000)
  - `DB_HOST`, `DB_USER`, `DB_PASSWORD`, `DB_NAME`
  - `JWT_SECRET`
- [ ] **Task 1.3: Database Connection Pool (`src/config/db.js`)**
...
- [ ] **Task 1.4: Database DDL Execution**
  Apply `src/db/schema.sql` and `src/db/seeds.sql` to your local MySQL server.

---

## Phase 2: Middlewares & Error Handling Layer

- [ ] **Task 2.1: JWT Authentication Middleware (`src/middlewares/auth.js`)**
...
- [ ] **Task 2.2: Role Authorization Guard (`src/middlewares/role.js`)**
  Implement `requireRole(...roles)`:
  - Check `req.user.role`.
  - Return `403 Forbidden` ("Insufficient permissions") if role doesn't match.
- [ ] **Task 2.3: Centralized Error Handler (`src/middlewares/errorHandler.js`)**
...
- [ ] **Task 3.1: Service Layer (`src/services/authService.js`)**
...
- [ ] **Task 3.2: Controller Layer (`src/controllers/authController.js`)**
  - Implement `register`, `login`, and `me` methods.
- [ ] **Task 3.3: Route Definition (`src/routes/authRoutes.js`)**
...
- [ ] **Task 4.1: Service Layer (`src/services/providerService.js`)**
...
- [ ] **Task 4.2: Controller & Routes (`src/controllers/providerController.js`, `src/routes/providerRoutes.js`)**
...
- [ ] **Task 5.1: Conflict Detection Engine (`src/services/bookingService.js`)**
...
- [ ] **Task 5.2: State Machine Implementation**
...
- [ ] **Task 5.3: Controller & Routes (`src/controllers/bookingController.js`, `src/routes/bookingRoutes.js`)**
...
- [ ] **Task 6.1: Atomic Review Submission (`src/services/reviewService.js`)**
  ...
  - Commit transaction.
- [ ] **Task 6.2: Controller & Routes (`src/controllers/reviewController.js`, `src/routes/reviewRoutes.js`)**
...
- [ ] **Task 8.1: Test Suite Script (`tests/smoke.sh` or Postman collection)**
